namespace YABE.Test.Extensions
{
    using System;
    ...
    public static class SpecificationExtensions
    {
        ...
        public static void ShouldNotContain(this ICollection actual, object expected)
        {
            foreach (var o in actual)
            {
                Assert.IsFalse(o == expected, String.Format("Expected not to find \"{0}\" in the collection, but did.", o));
            }
        }
